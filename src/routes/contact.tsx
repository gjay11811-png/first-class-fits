...
function ContactPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-16">
      ...
      <p className="mt-4 text-sm text-muted-foreground">We respond within 24 hours. Or email <a className="text-primary" href="mailto:gjay11811@gmail.com">gjay11811@gmail.com</a>.</p>
      {sent ? (
