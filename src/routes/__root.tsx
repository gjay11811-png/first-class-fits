...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Curated premium fashion, footwear, sportswear, electronics and accessories." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "First Class Fits" },
      { name: "twitter:description", content: "Curated premium fashion, footwear, sportswear, electronics and accessories." },
    ],
    links: [
